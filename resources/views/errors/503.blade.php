...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex items-center justify-center min-h-screen">
    ...
    <div class="text-center max-w-lg">
        ...
        <!-- Título -->
        <h1 class="text-4xl font-bold mb-3">ERRO 503</h1>

        <!-- Subtítulo -->
        <p class="text-gray-300 mb-8">
            Estamos realizando uma manutenção programada para melhorar nossos serviços. Por favor, tente novamente mais tarde.
        </p>

        <!-- Suporte -->
        <p class="text-gray-300 mb-8 font-bold">
            Se precisar de ajuda, por favor, entre em contato com nosso suporte dan.alves1411@gmail.com
        </p>
    </div>
