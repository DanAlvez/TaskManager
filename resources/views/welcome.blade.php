...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex items-center justify-center min-h-screen">
    ...
    <div class="text-center max-w-lg">
        ...
        <!-- Título -->
        <h1 class="text-4xl font-bold mb-3">TaskManager</h1>

        <!-- Subtítulo -->
        <p class="text-gray-300 mb-8">
            Organize suas tarefas, aumente sua produtividade e mantenha tudo sob controle.
        </p>
        ...
        @auth
            <div class="flex justify-center space-x-4">
                <a href="{{ route('dashboard') }}" 
                   class="px-6 py-2 bg-indigo-600 rounded-lg shadow hover:bg-indigo-700 transition">
                    Ínicio
                </a>
            </div>
        @else
        <div class="flex justify-center space-x-4">
            ...
            <a href="{{ route('register') }}" 
               class="px-6 py-2 bg-gray-700 rounded-lg shadow hover:bg-gray-600 transition">
                Registrar
            </a>
        </div>
        @endauth
