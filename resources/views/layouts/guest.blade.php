...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20,400,1,-50..200&icon_names=account_circle,close,delete,edit,logout,visibility,visibility_off" rel="stylesheet" />
